    ...
    <div className="min-h-screen bg-black overflow-x-hidden selection:bg-primary/30">
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-6 pt-20 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <h1 className="text-[56px] lg:text-[110px] font-bold text-white mb-8 leading-[1] tracking-tighter">
            Beyond Binary.<br />
            <span className="text-[#60A5FA]">Beyond AI.</span>
          </h1>

          <p className="text-white/60 text-lg leading-relaxed mb-10 font-inter max-w-4xl mx-auto">
      ...
      <section className="py-24 bg-[#0A0A0A] relative overflow-hidden border-t border-white/5">
        <div className="container mx-auto px-6 lg:px-24">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            ...
            >
              <h2 className="text-[42px] lg:text-[64px] font-bold text-white mb-8 leading-tight font-space">
                The Classical Wall
              </h2>
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden bg-black">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            <h2 className="text-[32px] lg:text-[52px] font-bold text-white mb-6 tracking-tight font-space">
              The 6<span className="text-[0.4em] ml-0.5 relative -top-[1em]">th</span> Layer Convergence
            </h2>
          ...
          >
            <div className="relative aspect-[21/9] lg:aspect-[3/1] w-full rounded-md overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(66,140,252,0.1)] bg-[#050B15]">
              ...
              />
              <div className="absolute top-4 left-4 w-5 h-5 z-20">
                <div className="absolute top-0 left-0 w-full h-[0.5px] bg-white/50" />
                <div className="absolute top-0 left-0 w-[0.5px] h-full bg-white/50" />
              </div>
              <div className="absolute top-4 right-4 w-5 h-5 z-20">
                <div className="absolute top-0 right-0 w-full h-[0.5px] bg-white/50" />
                <div className="absolute top-0 right-0 w-[0.5px] h-full bg-white/50" />
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-24">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <motion.div 
              ...
              className="p-8 rounded-xl bg-gradient-to-b from-[#1E293B] to-black border border-primary/30 shadow-[0_0_30px_rgba(66,140,252,0.15)] relative overflow-hidden"
            >
